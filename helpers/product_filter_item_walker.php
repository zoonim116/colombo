<?php
/**
 * Custom_WC_Product_Cat_Dropdown_Walker class
 *
 * @extends 	Walker
 * @class 		Custom_WC_Product_Cat_Dropdown_Walker
 */
...
class Custom_WC_Product_Cat_Dropdown_Walker extends Walker {
    ...
    $output .= "<li><a data-link='category_slug' href=".esc_attr( $value );
